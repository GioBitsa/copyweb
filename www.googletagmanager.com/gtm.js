    ...
    */
    ...
    var Wb = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/,
        ...
        I = function(a, b) {
            ...
            for (d in a)
                if (Yb(a, d)) {
                    var e = a[d];
                    "array" == Xb(e) ? ("array" != Xb(c[d]) && (c[d] = []), c[d] = I(e, c[d])) : Zb(e) ? (Zb(c[d]) || (c[d] = {}), c[d] = I(e, c[d])) : c[d] = e
                }
            return c
        };
    var $b = function(a) {
        ...
        Kc, Lc, Mc, Nc = function(a, b) {
            ...
            for (f in a)
                if (a.hasOwnProperty(f))
                    if (0 === f.indexOf("vtp_")) d && b && b.Wf && b.Wf(a[f]), e[void 0 !== d ? f : f.substr(4)] = a[f];
        ...
        Oc = function(a, b, c) {
            if (Aa(a)) {
                ...
                switch (a[0]) {
                    ...
                    case "tag":
                        var u = a[1];
                        if (!Hc[u]) throw Error("Unable to resolve tag reference " +
                            u + ".");
                        return d = {
                            cg: a[2],
                            index: u
    ...
    var Td = function(a) {
        ...
        ae = function(a, b) {
            ...
            var d = g(b) ? [b] : b,
                e = {};
            c().length !== d.length && Yd(d, function(f) {
                var h = c();
    ...
    var ce = [L.D, L.H],
        de = function(a) {
            ...
            for (var d = Aa(b) ? b : [b], e = {
                    ...
                    Nb: e.Nb
                }, ++e.Nb) Na(a, function(f) {
                return function(h, k) {
                    if (h !== L.Xe && h !== L.Ye) {
                        var l = d[f.Nb];
                        Nd().set(h, k, l, "GE", "GE-TB", c)
                    }
                }
            }(e))
        },
    ...
    var uh = /^\w+$/,
        ...
        yh = function(a, b) {
            Vd("ad_storage") ? xh() ? a() : ae(a, "ad_storage") : b ? ta("TAGGING", 3) : $d(function() {
                yh(a, !0)
            }, ["ad_storage"])
        },
        Ah = function(a) {
    ...
    function Uh(a, b) {
        Vd(L.D) ? N(L.D) ? a() : ae(a, L.D) : b ? vd(42) : he(function() {
            Uh(a, !0)
        }, [L.D])
    }
    ...
    var Ci = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        ...
        Fi = "google customPixels customScripts html nonGooglePixels nonGoogleScripts nonGoogleIframes".split(" ");
    var Gi = function() {
            var a = !1;
            return a
        },
        Ii = function(a) {
            ...
            return function(h) {
                ...
                var v = !n || r;
                v || !(0 <= Ba(l, "sandboxedScripts")) || c && -1 !== Ba(c, "sandboxedScripts") || (v = Ia(e, Fi));
                return f[k] = v
            }
        },
        Hi = function() {
    ...
    var sj = function(a) {},
        ...
        zj = function() {
            ...
            void 0 === Ej || Fj[Ej] && !Gj && !Hj || (Ij[Ej] || Jj.vi() || 0 >= Kj-- ? (vd(1), Ij[Ej] = !0) : (Jj.Ni(), Kb(yj(!0)), Fj[Ej] = !0, Lj = Mj = Nj = Hj = Gj = ""))
        },
        yj = function(a) {
            var b = Ej;
            if (void 0 === b) return "";
        ...
        Tj = 0 <= A.location.search.indexOf("?gtm_latency=") || 0 <= A.location.search.indexOf("&gtm_latency="),
        Uj;
    if (!(Uj = Tj)) {
        var Vj = Math.random(),
            Wj = Sj.sampleRate;
    ...
    var Jj = function(a, b) {
        ...
        dk = function(a, b, c, d) {
            if (Xj && b) {
                var e, f = String(b[ac.lb] || "").replace(/_/g, "");
    ...
    function Fk(a, b) {
        ...
        for (var c = 0; c < a.length; c++)
            if (a[c] && Hc[c] && !Gf[String(Hc[c][ac.lb])]) return !0;
        return !1
    }
    ...
    ob("Trident") || ob("MSIE");
    ob("Edge");
    !ob("Gecko") || -1 != lb.toLowerCase().indexOf("webkit") && !ob("Edge") || ob("Trident") || ob("MSIE") || ob("Edge"); - 1 != lb.toLowerCase().indexOf("webkit") && !ob("Edge") && ob("Mobile");
    ob("Macintosh");
    ob("Windows");
    ob("Linux") || ob("CrOS");
    ...
    Wk.prototype.addEventListener = function(a) {
        ...
        var e = function(f, h) {
            clearTimeout(d);
            f ? (b = f, b.internalErrorState = Vk(b), h && 0 === b.internalErrorState || (b.tcString = "tcunavailable", h || (b.internalErrorState = 3))) : (b.tcString = "tcunavailable", b.internalErrorState = 3);
            a(b)
        };
        try {
                                ...
                                for (k in dl)
                                    if (dl.hasOwnProperty(k))
                                        if ("1" === k) {
                                            ...
                                            var q;
                                            var r = n;
                                            !1 === r.gdprApplies ? q = !0 : (void 0 === r.internalErrorState && (r.internalErrorState = Vk(r)), q = "error" === r.cmpStatus || 0 !== r.internalErrorState || "loaded" === r.cmpStatus && ("tcloaded" === r.eventStatus || "useractioncomplete" ===
                                                r.eventStatus) ? !0 : !1);
    ...
    function xl(a) {
        function b(t) {
            ...
            if (!v[x]) {
                ...
                z("gclid", yl(d, l));
                z("gclsrc", n);
                if (!(w.gclid || w.dclid || w.gclaw) && (z("gbraid", yl(d, q)), !w.gbraid && Wd() && N(L.D))) {
                    var H = Ah("_gcl_gb");
                    z("gclgb", H.join("."))
                }
                z("gtm", Nk(!e));
            ...
            if (d.U) {
                ...
                if (f) {
                    var h = I(c),
                        ...
                        t = zf(yf(Af(xf(wf(vf(uf(tf(sf(h), k), l), n), p), function() {
                            kk(q, r, "2");
                            rn && u()
                        }), function() {
                            kk(q, r, "3");
    ...
    function lo(a, b) {
        ...
        b && (c.eventModel = I(b), b[L.Ab] && (c.eventCallback = b[L.Ab]), b[L.Kc] && (c.eventTimeout = b[L.Kc]));
        return c
    }
    ...
    var oo = {
            ...
            set: function(a) {
                var b;
                2 == a.length && Zb(a[1]) ?
                    b = I(a[1]) : 3 == a.length && g(a[1]) && (b = {}, Zb(a[2]) || Aa(a[2]) ? b[a[1]] = I(a[2]) : b[a[1]] = a[2]);
                if (b) {
                    b._clear = !0;
                    return b
                }
    ...
    Y.g.f = ["google"],
        function() {
            (function(a) {
                ...
                return b ? a.vtp_component && "URL" != a.vtp_component ? Ce(Ee(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : np(String(b)) : String(b)
            })
        }();
    ...
    Y.g.u = ["google"],
        function() {
            ...
            (function(b) {
                ...
                else f = Ce(e, d, "HOST" == d ? b[a("vtp_stripWww")] : void 0, "PATH" == d ? b[a("vtp_defaultPages")] : void 0, void 0);
                return f
            })
        }();
    ...
    }, Ws.onHtmlSuccess = Wo.Zf(!0), Ws.onHtmlFailure = Wo.Zf(!1);
    Ws.dataLayer = Xf;
    ...
    function Ys() {
        ...
        if (Q[Df.M]) {
            ...
            for (var n = c.rules || [], p = 0; p < n.length; p++) {
                for (var q = n[p], r = {}, u = 0; u <
                    q.length; u++) r[q[u][0]] = Array.prototype.slice.call(q[u], 1);
                Ac.push(r)
            }
            Jc = Y;
            Kc = ao;
            ...
            Ji = !1;
            Ki = 0;
            if ("interactive" == A.readyState && !A.createEventObject || "complete" == A.readyState) Mi();
            else {
    ...
    (function(a) {
        ...
        var f = function() {
                ...
                n || (n = [], m["google.tagmanager.debugui2.queue"] = n, Fb("https://www.googletagmanager.com/debug/bootstrap"));
                var p = {
