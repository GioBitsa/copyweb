...
if (document.body.classList.contains("home") && 991 < window.outerWidth) {
    var root = document.documentElement,
        box = document.querySelector(".hero"),
        height = box.offsetHeight,
        delay = !1;
    window.onscroll = function(e) {
        e.preventDefault(), delay || (delay = !0, setTimeout(function() {
            delay = !1
        }, 200), window.scrollY > height ? root.classList.add("scrolled") : root.classList.remove("scrolled"))
    }, gsap.timeline({
        scrollTrigger: {
            trigger: "#about",
            start: "top top",
...
(function(cc) {
    ...
    var util = {
        ...
        setCookie: function(name, value, expiryDays, domain, path) {
            ...
            var cookie = [name + "=" + value, "expires=" + exdate.toGMTString(), "SameSite=Lax", "path=" + (path || "/")];
    ...
    cc.Popup = function() {
        var defaultOptions = {
            ...
            window: '<div id="cc-window" data-nosnippet="true" role="dialog" aria-live="polite" aria-label="cookieconsent" aria-describedby="cookieconsent:desc" class="cmplz-tcf-banner-hidden cc-window {{classes}}">\x3c!--googleoff: all--\x3e{{children}}\x3c!--googleon: all--\x3e</div>',
        ...
        function getPopupClasses() {
            ...
            var classes = ["cc-" + positionStyle, "cc-type-" + opts.type, "cc-theme-" + opts.theme, "cmplz-animation-" + opts.animation];
            if (opts.static) {
        ...
        function addCustomStyle(hash, palette, prefix) {
            ...
            if (popup) {
                ...
                colorStyles[prefix + ".cc-window"] = ["color: " + popup.text, "background-color: " + popup.background, "border-style: solid", "border-width: " + popup.borderwidth, "border-color: " + popup.border, "border-radius: " + popup.borderradius, "-webkit-box-shadow: " + popup.boxshadow, "-moz-box-shadow: " + popup.boxshadow, "box-shadow: " + popup.boxshadow];
                colorStyles[prefix + ".cc-revoke"] = ["color: " + popup.text, "background-color: " + popup.background];
                colorStyles[prefix + " .cc-link," + prefix + " .cc-link:active," + prefix + " .cc-link:visited"] = ["color: " + popup.link];
                if (button) {
                    button.text = button.text ? button.text : util.getContrast(button.background);
                    button.border = button.border ? button.border : "transparent";
                    colorStyles[prefix + " .cc-btn"] = ["color: " + button.text, "border-color: " + button.border, "background-color: " + button.background, "border-radius: " + button.borderradius];
                    if (highlight) {
...
jQuery(document).ready(function($) {
    ...
    var cmplzCategories = [cmplzPrefix + "functional", cmplzPrefix + "preferences", cmplzPrefix + "statistics", cmplzPrefix + "marketing"];
