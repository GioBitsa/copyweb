(function(g) {
    ...
    var xPa = function(a, b) {
            ...
            for (var d = 0, e = 1, f = 0, h = 0; 8 > h; h++) {
                f = g.$q(a, c);
                var l = (g.$q(a, c + 1E-6) - f) / 1E-6;
                if (1E-6 > Math.abs(f - b)) return c;
                if (1E-6 > Math.abs(l)) break;
                else f < b ? d = c : e = c, c -= (f - b) / l
            }
            for (h = 0; 1E-6 < Math.abs(f - b) && 8 > h; h++) f < b ? (d = c, c = (c + e) / 2) : (e = c, c = (c + d) / 2), f = g.$q(a, c);
            return c
        },
        v5 = function() {
            return {
        ...
        w5 = function(a) {
            g.G.call(this);
            this.callback = a;
            this.u = new g.Zq(0, 0, .4, 0, .2, 1, 1, 1);
            this.delay = new g.Aq(this.next, window, this);
        ...
        x5 = function(a) {
            ...
            this.previous.Ra("click", this.vO, this);
            g.J(this, this.L);
            for (var c = 0; 16 > c; c++) {
                var d = new g.W({
                    D: "a",
                ...
                g.xl(e, "transitionDelay", c / 20 + "s");
                this.B.N(e, "click", g.Pa(this.wO,
                    c));
                this.u.push(d)
            }
            g.J(this, this.next);
            this.next.Ca(this.element);
            this.next.Ra("click", this.uO, this);
        ...
        yPa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                var c = a.suggestionData[b],
                    ...
                    f = c.zk();
                g.oF(a.api.T()) && (f = g.si(f, g.JM("emb_rel_err")));
                d.element.style.display = "";
                var h = d.Da("ytp-suggestion-title");
                g.Xq.test(c.title) ? h.dir = "rtl" : g.KKa.test(c.title) && (h.dir = "ltr");
                h = d.Da("ytp-suggestion-author");
                g.Xq.test(e) ? h.dir = "rtl" : g.KKa.test(e) && (h.dir = "ltr");
                h = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.aM(c.lengthSeconds) : "";
                d.update({
                    views_or_author: e,
                    duration: h,
                    link: f,
        ...
        APa = function(a, b) {
            var c, d, e, f, h;
            b.reason && (A5(b.reason) ? h = g.rA(b.reason) : h = g.SN(g.qA(b.reason)), a.fd(h, "content"));
            var l;
            b.subreason && (A5(b.subreason) ? l = g.rA(b.subreason) : l = g.SN(g.qA(b.subreason)), a.fd(l, "subreason"));
            if (b.proceedButton && b.proceedButton.buttonRenderer && (a = a.Da("ytp-error-content-wrap-subreason"), h = b.proceedButton.buttonRenderer, b = g.sg("A"), h.text && h.text.simpleText)) {
                l = h.text.simpleText;
                b.textContent = l;
                a: {
        ...
        B5 = function(a, b) {
            ...
            this.api = a;
            this.l = b;
            this.Ta("target", a.T().J);
            this.api.Tb(this.element, this, 96714);
            this.N(this.api, "presentingplayerstatechange", this.ih);
        ...
        E5 = function(a, b) {
            ...
            this.api = a;
            this.I = b;
            this.i = new g.dN(this);
            this.B = new g.OL(this, 1E3, !1, 100);
            this.u = [];
            this.suggestionData = [];
            this.containerWidth = 0;
            this.C = !1;
            ...
            this.U = this.tileWidth = this.l = 0;
            this.next = new g.W({
                D: "button",
                Fa: ["ytp-button", "ytp-next"],
                V: {
            ...
            g.J(this, this.previous);
            this.previous.Ca(this.element);
            this.previous.Ra("click", this.yO, this);
            g.J(this, this.L);
            for (a = 0; 16 > a; a++) {
                var d = new g.W({
                    D: "a",
                ...
                d.Ca(this.suggestions.element);
                var e = d.Da("ytp-suggestion-link");
                g.xl(e, "transitionDelay", a / 20 + "s");
                this.i.N(e, "click", g.Pa(this.zO, a));
                this.u.push(d)
            }
            g.J(this, this.next);
            this.next.Ca(this.element);
            this.next.Ra("click", this.xO, this);
            b = new g.W({
                D: "button",
            ...
            g.J(this, b);
            b.Ca(this.element);
            b.Ra("click", this.KS, this);
            g.J(this, this.expandButton);
            this.expandButton.Ca(this.element);
            this.expandButton.Ra("click", this.LS, this);
            this.i.N(this.api, "appresize", this.wb);
            this.i.N(this.api, "fullscreentoggled", this.Xl);
            this.i.N(this.api, "presentingplayerstatechange", this.Jc);
            this.i.N(this.api, "videodatachange", this.ob);
            this.wb(this.api.bb().getPlayerSize());
            this.ob()
        },
        F5 = function(a) {
            var b =
        ...
        BPa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                d.element.style.display = "";
                g.JKa.test(c.title) && (d.Da("ytp-suggestion-title").dir = "rtl");
                g.JKa.test(e) && (d.Da("ytp-suggestion-author").dir = "rtl");
                var f = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.aM(c.lengthSeconds) : "";
                var h = c.zk();
                g.oF(a.api.T()) && (h = g.si(h, g.JM("emb_rel_pause")));
                d.update({
                    author_and_views: e,
                    duration: f,
                    link: h,
                    ...
                    aria_label: c.Qo || null,
                    is_live: c.isLivePlayback,
                    aria_hidden: !(!c.Qo || a.api.T().X("embeds_rv_aria_hidden_killswitch")),
                    blink_rendering_hack: g.dj || g.mF ? "will-change: opacity" : void 0
                });
                d = d.Da("ytp-suggestion-image");
                c = c.De();
        ...
        G5 = function(a) {
            ...
            g.W.call(this, {
                ...
                V: {
                    target: b.J,
                    href: "{{url}}",
                    "aria-label": g.HI("Watch on $WEBSITE", {
                        WEBSITE: g.KF(b)
                    }),
            ...
            this.N(a, "videodatachange", this.GF);
            this.N(a, "videodatachange", this.ob);
            this.N(a, "presentingplayerstatechange", this.AO);
            this.N(a, "appresize", this.wb);
            b = this.state;
            this.state !== b && (this.state = b);
            this.GF();
            this.ob();
            this.wb(a.bb().getPlayerSize())
        },
        H5 = function(a) {
            g.nN.call(this, a);
            this.G = a;
            this.l = new g.dN(this);
            g.J(this, this.l);
            this.load()
        };
    g.w(w5, g.G);
    ...
    w5.prototype.next = function() {
        ...
        var b = this.u;
        a = xPa(b, a / this.duration);
        if (0 == a) b = b.C;
        else if (1 == a) b = b.L;
        else {
            var c = g.Tf(b.C, b.I, a),
                d = g.Tf(b.I, b.J, a);
            b = g.Tf(b.J, b.L, a);
            c = g.Tf(c, d, a);
            d = g.Tf(d, b, a);
    ...
    g.k.wO = function(a, b) {
        ...
        var c = a.sessionData;
        g.MN(b, this.api, this.J, c || void 0) && this.api.Kj(a.videoId, c, a.playlistId)
    };
    g.k.resize = function(a, b) {
        ...
        if (150 >= Math.min(a.width, a.height) || 0 === h || !c.Cb) this.hide();
        else {
            var l;
            if (e) {
                var m = l = 28;
            ...
            b && m + 100 > b && 50 < l && (m = Math.max(b, 50 / d), l = Math.ceil(a / (d * (m - 100) + this.i)), l = a / l - this.i,
                m = Math.floor(l / d));
            50 > l || g.YM(this.api) ? this.hide() : this.show();
            for (b = 0; b < h; b++) {
                d = this.u[b];
    ...
    g.k.ob = function() {
        ...
        this.J = b.C ? !1 : c.l;
        if (b.suggestions) {
            var d = g.Ho(b.suggestions, function(e) {
                return e && !e.list
            });
    ...
    z5.prototype.show = function() {
        g.RN.prototype.show.call(this);
        zPa(this, this.api.bb().getPlayerSize())
    };
    z5.prototype.resize = function(a) {
        g.RN.prototype.resize.call(this, a);
        zPa(this, a);
        g.O(this.element, "related-on-error-overlay-visible", !this.i.isHidden())
    };
    z5.prototype.l = function(a) {
        g.RN.prototype.l.call(this, a);
        var b = this.api.getVideoData();
        if (b.CB || b.playerErrorMessageRenderer)(a = b.CB) ? APa(this, a) : b.playerErrorMessageRenderer && APa(this, b.playerErrorMessageRenderer);
        else {
            var c;
            a.ji && (b.Jp ? A5(b.Jp) ? c = g.rA(b.Jp) : c = g.SN(g.qA(b.Jp)) : c = g.SN(a.ji), this.fd(c, "subreason"))
        }
    };
    g.w(B5, g.W);
    B5.prototype.ih = function() {
        this.api.ub().isCued() || (this.hide(), this.api.gb(this.element, !1))
    };
    B5.prototype.i = function() {
        var a = this.api.getVideoData(),
            ...
            f = this.l.lf();
        b = g.zF(b);
        d || f || c || e || b || !a.videoId ? (this.hide(), this.api.gb(this.element, !1)) : (a = g.si(this.api.getVideoUrl(), g.JM("emb_imp_woyt")), this.Ta("url", a), this.show())
    };
    B5.prototype.onClick = function(a) {
        var b = g.si(this.api.getVideoUrl(), g.JM("emb_imp_woyt"));
        g.NN(b, this.api, a);
        this.api.Eb(this.element)
    };
    B5.prototype.show = function() {
        this.api.ub().isCued() && (g.W.prototype.show.call(this), this.api.tv(this.element) && this.api.gb(this.element, !0))
    };
    g.w(C5, g.W);
    C5.prototype.l = function() {
        var a = this.api.ub(),
            b = this.api.getVideoData();
        g.T(this.api.T().experiments, "embeds_enable_muted_autoplay") && b.mutedAutoplay && (g.V(a, 2) && !this.yb ? (this.show(), this.i.show(), a = this.api.getVideoData(), this.Ta("text", a.QF), g.O(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.gb(this.element, this.yb), this.api.Ma("onMutedAutoplayEnds")) : this.hide())
    };
    ...
    D5.prototype.i = function() {
        var a = this.api.ub(),
            b = this.api.getVideoData();
        g.T(this.api.T().experiments, "embeds_enable_muted_autoplay") && b.mutedAutoplay && !g.V(a, 2) ? this.yb || (g.W.prototype.show.call(this), this.u.start(), this.api.gb(this.element, this.yb)) : this.hide()
    };
    D5.prototype.l = function() {
    ...
    g.k = E5.prototype;
    g.k.hide = function() {
        g.Mq(this.api.getRootNode(), "ytp-expand-pause-overlay");
        g.W.prototype.hide.call(this)
    };
    g.k.KS = function() {
        this.C = !0;
    ...
    g.k.zO = function(a, b) {
        if (1E3 > (0, g.Q)() - this.ea) g.ru(b), document.activeElement.blur();
        else {
            a = this.suggestionData[a];
            var c = a.sessionData;
            g.MN(b, this.api, this.J, c || void 0) && this.api.Kj(a.videoId, c, a.playlistId)
    ...
    g.k.Jc = function(a) {
        if (!(g.V(a.state, 1) || g.V(a.state, 16) || g.V(a.state, 32))) {
            var b = !g.T(this.api.T().experiments, "embeds_disable_pauseoverlay_on_autoplay_blocked_killswitch") && g.V(a.state, 1024);
            !g.V(a.state, 4) || g.V(a.state, 2) || b ? this.B.hide() : this.suggestionData.length && (this.C || (g.M(this.api.getRootNode(), "ytp-expand-pause-overlay"), F5(this)), this.B.show(), this.ea = (0, g.Q)())
        }
    };
    g.k.wb = function(a) {
        var b = 16 / 9,
    ...
    g.k.ob = function() {
        ...
        this.J = c.C ? !1 : b.l;
        if (c.suggestions) {
            var d = g.Ho(c.suggestions, function(e) {
                return e && !e.list
            });
            this.suggestionData = g.Qe(d, function(e) {
                e = g.GP(b, e);
    ...
    g.k.GF = function() {
        var a = this.api.getVideoData(),
            ...
            c = this.api.T();
        a = (a.mutedAutoplay || c.Db && !g.V(this.state, 2)) && !(b && c.pfpChazalUi);
        g.eL(this, a);
    ...
    g.k.ob = function() {
        ...
        } else this.i && (this.Ta("url", null), this.jc(this.i), this.i = null)
    };
    g.k.onClick = function(a) {
        var b = this.api.getVideoUrl(!g.bM(a), !1, !0, !0);
        g.NN(b, this.api, a);
        this.api.Eb(this.element)
    };
    g.k.wb = function(a) {
    ...
    g.k.create = function() {
        ...
        d && g.cB("cpn", d);
        b.Cb && (this.C = new E5(this.G, c), g.J(this, this.C), g.aN(this.G, this.C.element, 4));
        g.T(b.experiments, "embeds_enable_muted_autoplay") && (this.i = new D5(this.G), g.J(this, this.i), g.aN(this.G, this.i.element, 4), this.B = new C5(this.G), g.J(this, this.B), g.aN(this.G, this.B.element, 4));
        if (b.Db || this.i) this.watermark = new G5(this.G), g.J(this, this.watermark), g.aN(this.G,
            this.watermark.element, 7);
        g.T(b.experiments, "embeds_impression_link") && (this.u = new B5(this.G, c), g.J(this, this.u), g.aN(this.G, this.u.element, 7));
        this.l.N(this.G, "appresize", this.wb);
        this.l.N(this.G, "presentingplayerstatechange", this.ih);
        this.l.N(this.G, "videodatachange", this.yW);
        this.l.N(this.G, "onMutedAutoplayStarts", this.DT);
        this.Rb(this.G.ub());
    ...
    g.k.Rb = function(a) {
        g.V(a, 128) ? (this.pe || (this.pe = new z5(this.G), g.J(this, this.pe), g.aN(this.G, this.pe.element, 4)), this.pe.l(a.getData()), this.pe.show(), g.M(this.G.getRootNode(), "ytp-embed-error")) : this.pe && (this.pe.dispose(), this.pe = null, g.Mq(this.G.getRootNode(), "ytp-embed-error"))
    };
    g.k.DT = function() {
    ...
    g.k.yW = function() {
        ...
        this.watermark && this.i && !a.mutedAutoplay && g.yg(this.i.element, this.watermark.element) && g.aN(this.G, this.watermark.element, 7)
    };
    g.yN.embed = H5;
})(_yt_player);